                                    ...
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                                ...
                                                T-shirt Color: <span class="inline-block w-4 h-4 rounded-full border border-gray-300 dark:border-gray-600 align-middle ml-1" style="background-color: #{{ $item['color'] }};" title="{{ $item['color'] }}"></span>
                                            </p>
                                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
